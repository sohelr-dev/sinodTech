        ...
        <div class="card-body p-4 p-md-5">
          ...
          <form @submit.prevent="handleLogin">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                <input :type="showPassword ? 'text' : 'password'" v-model="form.password"
                  class="form-control form-control-lg bg-light border-0" :class="{ 'is-invalid': errors.password }"
                  placeholder="••••••••" />
                <button class="btn btn-light border-0" type="button" @click="showPassword = !showPassword">
                  <i :class="showPassword ? 'bi bi-eye-slash' : 'bi bi-eye'"></i>
                </button>
              </div>
              <div v-if="errors.password" class="text-danger mt-1 small">{{ errors.password[0] }}</div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <RouterLink to="/forget-password" class="small text-decoration-none fw-bold text-primary">Forgot password?</RouterLink>
            </div>
